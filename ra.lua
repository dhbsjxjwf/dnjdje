...
local Window = Library.CreateLib("The Rake Noob Edition GUI (", "GrapeTheme")
local Tab = Window:NewTab("菜单")
local MainSection = Tab:NewSection("Button")
local Tab = Window:NewTab("玩家")
local PSection = Tab:NewSection("Button")
local Tab = Window:NewTab("ESP")
local ESPSection = Tab:NewSection("Button")
local Tab = Window:NewTab("传送")
local TPSection = Tab:NewSection("Don't use too much (You will take fall damage)")
local Tab = Window:NewTab("Dex")
local DexExplorerSection = Tab:NewSection("Rake您可以查看他的健康状况")
MainSection:NewButton("重新加入", "If you want reset exploit or somethings", function()
...
MainSection:NewButton("无雾(使用前请单击“播放”！)", "", function()
...
MainSection:NewButton("移除自然", "", function()
...
MainSection:NewToggle("放大对象", "", function(state)
    if state then
...
MainSection:NewButton("解锁盒子聊天", "", function()
...
PSection:NewButton("无限的耐力", "", function()
...
PSection:NewButton("闪烁（按 B）（不推荐）", "(Unsupport Moblie) IT IS NOT LIKE FLY MODE ", function()
    local Speed = 80
...
PSection:NewSlider("奔跑速度 -->", "", 100, 34, function(s)
    game.Players.LocalPlayer.Character.CharValues.RunSpeed.Value = s
end)
PSection:NewButton("获取所有金属", "", function()
...
PSection:NewButton("删除电气损坏", "", function()
...
ESPSection:NewButton("Rakoof(如果他死了，请再次单击)", "He has 3500 health", function()
text = "RAKOOF"
...
ESPSection:NewButton("金属", "", function()
...
ESPSection:NewButton("平移生成位置", "", function()
...
TPSection:NewButton("发电站", "", function()
...
TPSection:NewButton("Destroyed Shelter", "", function()
local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
local object = "Part"
local pos = p1.CFrame
...
TPSection:NewButton("拉库夫之家旅馆", "", function()
    local pl = game.Players.LocalPlayer.Character.HumanoidRootPart
...
TPSection:NewDropdown("平移生成位置", "", {"PanGiver1", "PanGiver2", "PanGiver3", "PanGiver4", "PanGiver5", "PanGiver6", "PanGiver7", "PanGiver8", "PanGiver9", "PanGiver10"}, function(v)
local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
...
TPSection:NewButton("普通金属", "", function()
for _, obj in pairs(game.Workspace.StuffGiversFolder.ScrapMetals:GetChildren()) do
...
TPSection:NewButton("低金属", "", function()
for _, obj in pairs(game.Workspace.StuffGiversFolder.ScrapMetals:GetChildren()) do
