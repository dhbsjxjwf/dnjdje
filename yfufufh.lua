...
local KillingCheats = PhantomForcesWindow:NewSection("菜单")
...
KillingCheats:CreateToggle("团队检查", function(state)
print(value)
getgenv().TeamCheck = state
end)

KillingCheats:CreateToggle("禁止行走", function()
print("HI")
...
KillingCheats:CreateToggle("命中框 ", function(v)
print(value)
...
local KillingCheats = PhantomForcesWindow:NewSection("混合")
...
local KillingCheats = PhantomForcesWindow:NewSection("枪")
